...
int main(int argc, const char **argv)
{
	...
	/* If no url parameter is specified in the query string, let's
	 * pretend that virtual-root is SCRIPT_NAME (if undefined) and
	 * use PATH_INFO as the url.  This allows cgit to work with
	 * pretty urls  without the need for rewrite rules in the web
	 * server.
	 */
	if (!ctx.qry.url) {
